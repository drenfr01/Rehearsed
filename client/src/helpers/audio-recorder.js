...
export async function startAudioRecorderWorklet(audioRecorderHandler) {
  ...
  // Set up the message handler but don't connect yet
  ...
  // Return the components without connecting them yet
  return [audioRecorderNode, audioRecorderContext, micStream, source];
}
